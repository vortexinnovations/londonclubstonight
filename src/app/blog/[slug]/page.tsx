    ...
    case 'late-night-food-after-london-clubs':
      return (
        <>
          ...
          <p className="text-[#BBB] leading-relaxed mb-4">
            After two or three hours on the dancefloor and a few drinks, the first thing most people want at 3am is food, and the second thing is a fast way to find it. London has more late-night food than most visitors realise, but the genuinely good spots are clustered in a few specific areas, and the rubbish ones can flatten the end of an otherwise excellent night. This is the post-club food map we send our own groups when they message us asking where to eat after a night at <Link href="/clubs/tape-london" className="text-[#C0C0C0] underline underline-offset-2 hover:text-white">Tape London</Link>, <Link href="/clubs/cirque-le-soir" className="text-[#C0C0C0] underline underline-offset-2 hover:text-white">Cirque le Soir</Link>, or <Link href="/clubs/maddox" className="text-[#C0C0C0] underline underline-offset-2 hover:text-white">Maddox Club</Link>.
          </p>
          <p className="text-[#BBB] leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">Soho - The Easiest Walk After a Central London Club</h2>
          <p className="text-[#BBB] leading-relaxed mb-4">
            If you have been at Tape, Cirque, <Link href="/clubs/funky-buddha" className="text-[#C0C0C0] underline underline-offset-2 hover:text-white">Funky Buddha</Link>, or anywhere in the central cluster, Soho is your first port of call. The streets between Wardour, Frith, and Old Compton stay alive past 3am in a way that almost no other London neighbourhood does.
          </p>
          <p className="text-[#BBB] leading-relaxed mb-4">
          ...
          <p className="text-[#BBB] leading-relaxed mb-4">
            Around the corner, Old Compton Street has a small cluster of pizza-by-the-slice spots and kebab shops that run until around 5am. The quality varies sharply. Stick to the places with visible turnover and avoid anywhere with food sitting under heat lamps and no one buying it. As <a href="https://www.timeout.com/london/restaurants/londons-best-late-night-restaurants" target="_blank" rel="noopener noreferrer" className="text-[#C0C0C0] underline underline-offset-2 hover:text-white">Time Out&apos;s late-night restaurants guide</a> notes, Soho remains London&apos;s most reliable post-midnight food district.
          </p>

          <h2 className="text-2xl font-bold text-white mt-10 mb-4">Mayfair to Marble Arch - Late Options Near the West End Clubs</h2>
          <p className="text-[#BBB] leading-relaxed mb-4">
            If you are coming out of <Link href="/clubs/cuckoo-club" className="text-[#C0C0C0] underline underline-offset-2 hover:text-white">Cuckoo Club</Link>, Maddox, or anywhere in the Mayfair pocket, your options inside Mayfair itself are limited after 3am. Most hotel restaurants close by midnight and the area is largely residential. Your best bets are either to walk east into Soho or south toward Piccadilly.
          </p>
          <p className="text-[#BBB] leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">24-Hour Spots Worth the Cab Fare</h2>
          <p className="text-[#BBB] leading-relaxed mb-4">
            For anyone willing to take a short cab ride, there are a few genuinely 24-hour places that justify the trip.
          </p>

          <h3 className="text-xl font-bold text-white mt-8 mb-3">Beigel Bake, Brick Lane</h3>
          <p className="text-[#BBB] leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-bold text-white mt-8 mb-3">VQ, Great Russell Street</h3>
          <p className="text-[#BBB] leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-bold text-white mt-8 mb-3">Polo Bar, Bishopsgate</h3>
          <p className="text-[#BBB] leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4">What to Avoid at 3am</h2>
          <p className="text-[#BBB] leading-relaxed mb-4">
          ...
          <p className="text-[#BBB] leading-relaxed mb-4">
            For the rest of your post-club logistics, our <Link href="/blog/getting-home-from-london-clubs" className="text-[#C0C0C0] underline underline-offset-2 hover:text-white">guide to getting home from London clubs</Link> pairs nicely with this one. The transport plan and the food plan should be made together, ideally before you leave the house.
          </p>

          <h2 className="text-2xl font-bold text-white mt-10 mb-4">Plan Your Post-Club Meal Before You Even Leave</h2>
          <p className="text-[#BBB] leading-relaxed mb-4">
