  ...
  return (
    ...
    <section className="relative min-h-[40vh] flex items-end overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 pb-12 pt-20">
        <span className="eyebrow animate-fade-up mb-5">Book direct</span>
        <h1 className="animate-fade-up anim-delay-1 font-display text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-6">
          Book a Table or Join <span className="serif-accent text-gradient">Guestlist</span>
        </h1>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid md:grid-cols-2 gap-6 mb-16">
        ...
        <div className="glass-card p-8">
          <div className="w-12 h-12 bg-wa-500/10 rounded-xl flex items-center justify-center mb-6">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--color-wa-500)" strokeWidth="2">
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
            </svg>
          </div>
          <h2 className="font-display text-2xl font-extrabold tracking-tight text-white mb-3">Book a VIP Table</h2>
          ...
          <a
            ...
            className="btn-whatsapp w-full py-4 px-6"
          >
        ...
        <div className="glass-card p-8">
          <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center mb-6">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--color-neon-300)" strokeWidth="2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-ghost w-full py-4 px-6"
          >
      ...
      {/* FAQ Section */}
      <section className="section-glow mb-16">
        <span className="eyebrow mb-4">Good to know</span>
        <h2 className="font-display text-2xl font-extrabold tracking-tight text-white mb-8">Common <span className="serif-accent text-gradient">Questions</span></h2>
        <div className="space-y-6">
          <div className="glass-card p-6">
            <h3 className="font-display font-bold tracking-tight text-white mb-2">Why WhatsApp instead of a booking form?</h3>
          ...
          <div className="glass-card p-6">
            <h3 className="font-display font-bold tracking-tight text-white mb-2">How quickly will I get a response?</h3>
            <p className="text-frost-300 text-sm leading-relaxed">
      ...
      <section>
        ...
        <h2 className="font-display text-2xl font-extrabold tracking-tight text-white mb-6">Looking for Something <span className="serif-accent text-gradient">Specific?</span></h2>
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          >
            <h3 className="font-display font-bold tracking-tight text-white mb-1">Bottle Service & Pricing</h3>
            <p className="text-frost-300 text-sm">Detailed pricing, packages, and bottle menus at londonbottleservice.com</p>
          </a>
          <a
            ...
            className="glass-card glass-card-hover block p-5"
          >
            <h3 className="font-display font-bold tracking-tight text-white mb-1">Birthday Celebrations</h3>
            <p className="text-frost-300 text-sm">Birthday packages and planning at londonbirthdayclub.com</p>
          </a>
          <a
            ...
            className="glass-card glass-card-hover block p-5"
          >
            <h3 className="font-display font-bold tracking-tight text-white mb-1">Tonight in Mayfair</h3>
            <p className="text-frost-300 text-sm">Tonight&apos;s Mayfair events and guestlists at mayfairtonight.com</p>
          </a>
          <a
            ...
            className="glass-card glass-card-hover block p-5"
          >
            <h3 className="font-display font-bold tracking-tight text-white mb-1">Luxury Nightlife Guide</h3>
            <p className="text-frost-300 text-sm">Premium London nightlife experiences at londonluxurynightlife.com</p>
          </a>
        </div>
      </section>
    </div>
